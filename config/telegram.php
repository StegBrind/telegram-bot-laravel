...
return [
    ...
    'bots'                         => [
        'mybot' => [
            ...
            'commands'            => [
                ...
                |--------------------------------------------------------------------------
                |
                | Commands that triggers when telegram user sent text message without a slash.
                |
                */
                'phrases',
                'test_phrases'
    ...
    */
    'command_groups'               => [
        'phrases' => [
            App\Telegram\Commands\Phrases\MainMenuCommand::class,
        ],

        'tests' => [
            App\Telegram\Commands\Tests\TestCommand::class,
        ],

        'test_phrases' => [
            App\Telegram\Commands\Tests\Phrases\TestPhraseCommand::class,
            App\Telegram\Commands\Tests\Phrases\PhotoTestCommand::class,
            App\Telegram\Commands\Tests\Phrases\ShowCompaniesCommand::class,
            App\Telegram\Commands\Tests\Phrases\AddCompanyCommand::class,
        ],
        /* // Group Type: 1
           'commmon' => [
